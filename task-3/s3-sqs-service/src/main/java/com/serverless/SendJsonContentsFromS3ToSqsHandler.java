...
public class SendJsonContentsFromS3ToSqsHandler implements RequestHandler<Map<String, Object>, Void> {

    private static final Logger LOG = LogManager.getLogger(SendJsonContentsFromS3ToSqsHandler.class);
